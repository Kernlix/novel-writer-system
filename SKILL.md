...
系统包含 **36 个专业智能体**，分布在 7 个部门。完整注册表见 `company/REGISTRY.md`：

| 部门 | 数量 | 核心Agent |
|:-----|:---:|:---------|
| 负责人部门 | 2 | manager·知识检索 |
| 写作部门 | 12 | 写手·角色·剧情·喜剧写手·恋爱写手·身份悬疑·疑似家族·技法检索·创作设定·短故事·大纲守护·时间线 |
...
| 悬疑 | `shadow-narrative-tricks` | 影子叙事诡计 | 影子设定+本体关系+揭示时机 |
| 悬疑 | `closed-space-suspense` | 封闭空间悬疑 | 孤岛设定+信息隔离+空间叙事 |
| 悬疑 | `time-loop-practical` | 时间循环实操 | 循环规则+信息增量+循环代价 |
| 成长 | `reincarnation-growth-arc` | 重生者成长弧线设计 | 前世阴影→分阶段成长→突破 |
| 成长 | `master-apprentice-progression` | 师徒关系渐进 | 六阶段模型+不可替代性+告别 |
| 成长 | `reincarnator-psychology` | 重生者心理刻画 | 创伤后应激+知道≠做到 |
